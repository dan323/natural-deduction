...
public class ParseModalActionTest {
    ...
    public void parseAndETest() {
        ...
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", new ConjunctionModal(p, q))), new LabeledExpression<>("s0",p));
        var conj1 = new ModalAndE1<String>(1);
        conj1.apply(mnd);
        List<AbstractModalAction<String>> lst = ParseModalAction.parse(mnd);
        ...
        conj2.apply(mnd);
        lst = ParseModalAction.parse(mnd);
        assertEquals(2, lst.size());
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", new ConjunctionModal(p, q))), new LabeledExpression<>("s0", p));
    ...
    public void parseAndITest() {
        ...
        var p = new VariableModal("P");
        var q = new VariableModal("Q");
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", p), new LabeledExpression<>("s0", q)), new LabeledExpression<>("s0", new ConjunctionModal(p, q)));
    ...
    public void parseOrITest() {
        ...
        var p = new VariableModal("P");
        var q = new VariableModal("Q");
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", p)), new LabeledExpression<>("s0", new DisjunctionModal(p, q)));
    ...
    public void parseOrETest() {
        ...
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", new DisjunctionModal(p, q)), new LabeledExpression<>("s0", new ImplicationModal(p, r)), new LabeledExpression<>("s0", new ImplicationModal(q, r))), new LabeledExpression<>("s0", r));
    ...
    public void parseCopyRelations() {
        ...
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", p), new LabeledExpression<>("s0", q)), new LabeledExpression<>("s0", q));
        var copy = new ModalCopy<String>(1);
        copy.apply(mnd);
        var lst = ParseModalAction.parse(mnd);
    ...
    public void parseNot() {
        var mnd = new ModalNaturalDeduction<String>();
        var p = new VariableModal("P");
        mnd.initializeProof(List.of(), new LabeledExpression<>("s0", new ImplicationModal(p, new NegationModal(new NegationModal(p)))));
    ...
    public void parseImp() {
        ...
        var p = new VariableModal("P");
        var q = new VariableModal("Q");
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", new ImplicationModal(p, q)), new LabeledExpression<>("s0", p)), new LabeledExpression<>("s0", q));
    ...
    public void parseBox() {
        var mnd = new ModalNaturalDeduction<String>();
        var p = new VariableModal("P");
        mnd.initializeProof(List.of(new LabeledExpression<>("s0", new Always(p))), new LabeledExpression<>("s0", p));
