...
public class ModalNotTest {
    ...
    public void modalNotIApply() {
        ...
        assume.apply(pf);
        pf.getSteps().add(new LabeledProofStep<>(1, state, bottom, new ProofReason("TST", List.of())));
        modalnoti.apply(pf);
        ...
        assume3.apply(pf);
        assume.apply(pf);
        pf.getSteps().add(new LabeledProofStep<>(3, state, bottom, new ProofReason("TST", List.of())));
        modalnoti.apply(pf);
