...
public final class ModalAndI extends AndI implements ModalAction {
    ...
    public ModalAndI(int i1, int i2) {
        super(i1, i2, (l1, l2) -> new ConjunctionModal((ModalLogicalExpression) l1, (ModalLogicalExpression) l2));
    }
    ...
    public void apply(Proof pf) {
        applyStepSupplier(pf, ((assLevel, log, reason) -> new ProofStepModal(((ProofStepModal) pf.getSteps().get(get1() - 1)).getState(), assLevel, log, reason)));
    }
}