...
public final class ParseClassicalAction {
    ...
    public static List<? extends Action<?,?,?>> parse(Proof<?,?> proof) {
        return ((ParseAction<ClassicalAction, NaturalDeduction>) ParseClassicalAction::parse).translateToActions((NaturalDeduction)proof);
    }

    public static ParseAction<ClassicalAction, NaturalDeduction> parseAction(){
        return ParseClassicalAction::parse;
    }
