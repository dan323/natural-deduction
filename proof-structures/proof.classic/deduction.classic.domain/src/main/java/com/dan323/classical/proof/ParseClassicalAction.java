...
import com.dan323.expressions.ClassicalParser;
...
public final class ParseClassicalAction {
    ...
    public static List<ClassicalAction> parse(NaturalDeduction proof) {
        ParseAction<ClassicalAction,NaturalDeduction> parseAction = ParseAction.toParseAction(() -> "classical", ParseClassicalAction::parse);
        return parseAction.translateToActions(proof);
    }
