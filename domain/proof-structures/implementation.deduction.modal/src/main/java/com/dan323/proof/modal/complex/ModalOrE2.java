...
public final class ModalOrE2 extends CompositionRule {
    ...
    public boolean isValid(ModalNaturalDeduction pf) {
        if (ModalAction.checkEqualState(pf, a, b) && RuleUtils.isValidIndexAndProp(pf, a) && RuleUtils.isValidIndexAndProp(pf, b)
                && RuleUtils.isOperation(pf, a, Disjunction.class) && RuleUtils.isOperation(pf, b, Negation.class)) {
