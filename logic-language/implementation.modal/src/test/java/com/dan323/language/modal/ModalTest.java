...
public class ModalTest {
    ...
    public void modalToStringTest() {
        ...
        ModalLogicalExpression clo = new Sometime(new ImplicationModal(new DisjunctionModal(v, c), new ConjunctionModal(c, v)));
    ...
    public void modalToStringTest2() {
        ConstantModal c = ConstantModal.FALSE;
        VariableModal v = new VariableModal("P");
        ModalLogicalExpression clo = new Always(new ImplicationModal(new DisjunctionModal(v, c), new ConjunctionModal(c, v)));
