...
public final class ModalLogicParser extends AbstractEvaluator<ModalOperation> {
    ...
    protected ModalOperation evaluate(Constant constant, Object evaluationContext) {
        return constant.getName().equals("FALSE") ? ConstantModal.FALSE : ConstantModal.TRUE;
    }
